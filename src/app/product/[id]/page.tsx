...
export default function ProductPage() {
  ...
  const discountedPrice = isApproved && !isAdmin ? calculateDiscountedPrice(product.price, product.salePrice) : (product.salePrice && product.salePrice > 0 ? product.salePrice : product.price);
