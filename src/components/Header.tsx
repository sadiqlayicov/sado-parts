          ...
          <div className="flex items-center justify-between h-10 text-xs lg:text-sm">
            <div className="flex items-center space-x-4 lg:space-x-6">
              <div className="flex items-center space-x-1">
                ...
                <span className="text-cyan-300">+7 (999) 123-45-67</span>
              </div>
              <div className="flex items-center space-x-1">
                <svg className="w-3 h-3 lg:w-4 lg:h-4 text-cyan-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="text-cyan-300">info@sado-parts.ru</span>
              </div>
            </div>
            <div className="flex items-center space-x-4 lg:space-x-6">
              <div className="flex items-center space-x-1">
                ...
                <span className="text-cyan-300">Пн-Пт: 9:00-18:00</span>
              </div>
              <div className="flex items-center space-x-1">
                <svg className="w-3 h-3 lg:w-4 lg:h-4 text-cyan-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-cyan-300">Москва, ул. Примерная, 123</span>
              </div>
            </div>
          </div>
        </div>
